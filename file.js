function CreateWhatsappChatWidget(option = {
    ...
    if (window.jQuery) {
        ...
        script.src = 'https://scrm-data-us-oss.oss-us-west-1.aliyuncs.com/sender/whatsapp_replace_crisp/jquery.js';
    ...
    let strData = '&event_type=600003'+'&host='+window.location.host+'&href='+window.location.href
    url = url + strData;
    sendRequest('GET', url);
    function initWidget() {
